...
class Zutaten extends PDO {
	...
	public function createMethod($zutaten_name, $fk_rezepte) {
	...
	public function checkUserExist($username) {
      ...
      return $result;
    		...
    		// Alle Zutaten
		public function getSingleZutaten($name) {
			$query = "SELECT name FROM zutaten WHERE name = :name" ;
			$stmt = $this -> prepare($query);
      ...
      return $result;
       		...
       		// Alle Zutaten
		public function getZutatenID($id) {
			$query = "SELECT id FROM zutaten WHERE id = :id" ;
			$stmt = $this -> prepare($query);
